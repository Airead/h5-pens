...
var Point = function (argX, argY, typeArg) {
    var self = this;
...
var ActionsSet = function (interalArg, actionsArrayArg) {
    var self = this;
...
var Recording = function (drawingArg) {
    var self = this;
...
function RecordableDrawing(canvasId) {
    var self = this;
    this.canvas = null;
